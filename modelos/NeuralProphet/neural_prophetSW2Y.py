...
def treinar_modelo(n_lags, epochs, batch_size, learning_rate):
    ...
    if rmse_mean < metrics_params_sw2y["best_rmse"]:
        ...
        metrics_params_sw2y["best_n_lags"] = n_lags
        metrics_params_sw2y["best_batch_size"] = batch_size
        metrics_params_sw2y["best_learning_rate"] = learning_rate

    with open(metrics_file2, "a") as f:
        f.write(
            f"NP-SW2Y,{n_lags},{epochs},{batch_size},{learning_rate},{rmse_mean},{rmse_std},{mae_mean},{mae_std},{mape_mean},{mape_std},{r2_mean},val\n"
            # f"NP-SW2Y,{n_lags},{batch_size},{learning_rate},{rmse_mean},{rmse_std},{mae_mean},{mae_std},{mape_mean},{mape_std},{r2_mean},val\n"
        )
    ...
    ytrue_yhat_df.to_csv(
        os.path.join(
            results_csv_dir,
            f"NP-SW2Y_{n_lags}_{epochs}_{batch_size}_{learning_rate}_{timestamp}.csv",
            # f"NP-SW2Y_{n_lags}_{batch_size}_{learning_rate}_{timestamp}.csv",
        ),
        index=False,
    )
...
with open(metrics_file, "a") as f:
    f.write(
        "NP-SW2Y,{},{},{},{},{},{},{},{},val\n".format(
            metrics_params_sw2y["best_n_lags"],
            metrics_params_sw2y["best_epochs"],
            metrics_params_sw2y["best_batch_size"],
            metrics_params_sw2y["best_learning_rate"],
...
for i, (trainidxs, testidxs) in enumerate(SW2Y_test.split(df)):
    ...
    model = NeuralProphet(
        ...
        batch_size=metrics_params_sw2y["best_batch_size"],
        n_lags=metrics_params_sw2y["best_n_lags"],
        learning_rate=metrics_params_sw2y["best_learning_rate"],
        n_forecasts=len(y_t),
    )
...
with open(metrics_file, "a") as f:
    f.write(
        f"NP-SW2Y,{metrics_params_sw2y['best_n_lags']},{metrics_params_sw2y['best_epochs']},{metrics_params_sw2y['best_batch_size']},{metrics_params_sw2y['best_learning_rate']},{rmse_mean},{mae_mean},{mape_mean},{r2_mean},test\n"
    )
