...
# # Acessando os componentes individuais
# trend_component = result.trend
# seasonal_component = result.seasonal
# residual_component = result.resid

# # Criando subplots para cada componente
...
# # Plotando cada componente em seu próprio subplot
...
# axs[0].set_ylabel("Água produzida", fontsize=font_size_labels)
...
# # Crie listas separadas para armazenar os valores do DF
...
# # Salva o gráfico como ACF_PACF.pdf
